...
def classify_image_sobel(features, threshold=0.95):
    """Classify image as Cracked or Non-cracked based on Sobel edge detection"""
    if features is None:
        return None
    
    # Images with higher edge density are more likely to be cracked
    prediction = features['sobel_edge_density'] > threshold
